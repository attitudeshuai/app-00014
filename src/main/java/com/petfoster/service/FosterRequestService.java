...
public class FosterRequestService {
    ...
    @Transactional
    @CheckOwnership(
            resourceType = ResourceType.PET,
            idIndex = 1,
            idField = "petId",
            userIdIndex = 0,
            role = OwnershipRole.OWNER,
            errorMessage = "只能为自己的宠物创建寄养申请"
    )
    ...
    @CheckOwnership(
            ...
            idIndex = 1,
            userIdIndex = 0,
            role = OwnershipRole.OWNER_OR_FOSTERER,
            errorMessage = "无权限修改此寄养申请状态"
    )
